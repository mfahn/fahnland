...
<div class="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg text-center dark:text-bg-gray dark:bg-navy">
    ...
    <div class="ring-dark p-2 ml-1 mr-1">
        <a class="hover:ring-lowTeal hover:text-lowTeal text-lg font-bold dark:ring dark:ring-lowTeal dark:hover:ring-midTeal dark:hover:text-teal" href="http://www.therealpresence.org/">Catholic Resource</a>
        <div class="text-base mr-auto ml-auto p-5 w-4/5">
    ...
    <div class="ring-dark p-2 ml-1 mr-1">
        <a class="hover:ring-lowTeal hover:text-lowTeal text-lg font-bold dark:ring dark:ring-lowTeal dark:hover:ring-midTeal dark:hover:text-teal" href="http://www.miracolieucaristici.org/en/Liste/list.html">Index of Eucharistic Miracles</a>
        <div class="text-base mr-auto ml-auto p-5 w-4/5">
    ...
    <div class="ring-dark p-2 ml-1 mr-1 ">
        <a class="hover:ring-lowTeal hover:text-lowTeal text-lg font-bold dark:ring dark:ring-lowTeal dark:hover:ring-midTeal dark:hover:text-teal" href="http://www.carloacutis.com/en/association/presentazione">Blessed Carlos Acutis</a>
        <div class="text-base mr-auto ml-auto p-5 w-4/5">
