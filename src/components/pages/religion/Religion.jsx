...
<div class="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
    ...
    <div class="ring-dark p-2">
        <div class=" "><Link class="hover:ring-lowTeal hover:text-lowTeal text-lg font-bold ml-auto mr-auto text-center dark:ring dark:ring-lowTeal dark:hover:ring-midTeal dark:hover:text-teal" to="https://jesusisreal-stl.org/">Evidence of the Existence of Jesus Christ</Link></div>
    ...
    <div class="ring-dark p-2">
        <Link class="hover:ring-lowTeal hover:text-lowTeal text-lg font-bold text-center ml-auto mr-auto dark:ring dark:ring-lowTeal dark:hover:ring-midTeal dark:hover:text-teal" to="http://www.miracolieucaristici.org/en/Liste/list.html">Index of Eucharistic Miracles</Link>
        <div class="text-base pt-5">
    ...
    <div class="ring-dark p-2 ">
        <Link class="hover:ring-lowTeal hover:text-lowTeal text-lg font-bold text-center ml-auto mr-auto dark:ring dark:ring-lowTeal dark:hover:ring-midTeal dark:hover:text-teal" to="http://www.carloacutis.com/en/association/presentazione">Blessed Carlos Acutis</Link>
        <div class="text-base pt-5">
    ...
    <div class="ring-dark p-2">
        <Link class="hover:ring-lowTeal hover:text-lowTeal text-lg font-bold text-center ml-auto mr-auto dark:ring dark:ring-lowTeal dark:hover:ring-midTeal dark:hover:text-teal" to="http://www.therealpresence.org/">Catholic Resource</Link>
        <div class="text-base pt-5">
