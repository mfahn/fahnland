...
<div className="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
    ...
    <div className="ring-dark p-2">
        <div className="font-bold text-center">The Shroud of Turin</div>
        <div className="text-base pt-5">
            This entry is a little different: instead of a website, this is a book review of the Shroud of Turin, by ______. In it, he details a Herculean effort by a large number of scientists in the 80's to rigorously study the Shroud of Turin using the best technology available at the time. The Shroud is the cloth in which Jesus Christ was supposedly buried after his death. A group of _____ scientists from highly respected agencies such as the Jet Propulsion Laboratory, _____, _____, created tests, assembled scientific equipment, and organized travel and lodging to study this cloth over a period of a few days. They all did this in their spare time and at substantial personal cost to obtain a scientifically definitive answer about the cloth's legitimacy. Not to spoil the book, but their findings were incredible and impossible. Most of the scientists were a-religious at the time of study and their main interest was in disproving once and for all that the Shroud was fake and concocted by the Catholic establishment. 
        </div>
    </div>
    </div>
</div>
