...
<div class="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
  ...
  <h1 class="text-2xl font-bold text-center">Redline Investigation</h1>
  <p class="text-sm text-center text-dark dark:text-bg-gray p-5">
      Michael Fahnlander 3/22/23
    </p>

  <h1 class="text-lg font-bold text-center">Executive Summary</h1>
<p class="text-base text-dark dark:text-bg-gray">
  ...
  <h1 class="text-lg font-bold text-center">Environment</h1>
...
<p class="text-base text-dark dark:text-bg-gray">
  ...
  <h1 class="text-lg font-bold text-center">Methodology</h1>
<p class="text-base text-dark dark:text-bg-gray">
...
<h1 class="text-md font-bold text-center">Sample 1</h1>
...
<h1 class="text-md font-bold text-center">Sample 2</h1>
...
<p class="text-base text-center text-dark dark:text-bg-gray">
Cs9.wpc.v0cdn.net
</p>
<p class="text-base text-center text-dark dark:text-bg-gray">
Cs22.wpc.v0cdn.net
...
<h1 class="text-lg font-bold text-center">Host Findings</h1>
...
<h1 class="text-lg font-bold text-center">Related Tools</h1>
...
<h1 class="text-lg font-bold text-center">Takeaways</h1>
...
<h1 class="text-lg font-bold text-center">Conclusion</h1>
<p class="text-base text-dark dark:text-bg-gray">
