...
<div class="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
  <div class="lg:w-4/5 sm:w-7/8 m-auto">
    <h1 class="text-2xl font-bold text-center">Ransomware Incident Response Playbook</h1>
    <p class="text-sm text-center text-dark dark:text-bg-gray">
      Michael Fahnlander 3/22/23
    </p>
    
    <h1 class="text-lg mt-5 font-bold text-center">Incident Preparation</h1>
    <ol class="p-5 text-base text-dark dark:text-bg-gray list-decimal">
...
<table class="table-auto m-auto w-full">
  <thead>
    <tr class="border border-dark dark:border-bg-gray">
      <th class="border border-dark dark:border-bg-gray p-3">Artifact</th>
      ...
      <th class="border border-dark dark:border-bg-gray p-3 w-2/5">Collector</th>
      <th class="border border-dark dark:border-bg-gray p-3 w-2/5">Witness</th>
    </tr>
  </thead>
  <tbody>
...
<h1 class="text-lg font-bold text-center">Eradication</h1>
<ol class="p-5 text-base text-dark dark:text-bg-gray list-decimal">
  <li>Identify IoCs</li>
...
<h1 class="text-lg font-bold text-center">Communication Log</h1>
  <table class="table-auto m-auto w-full">
  <thead>
    <tr class="border border-dark dark:border-bg-gray">
      <th class="border border-dark dark:border-bg-gray p-3">Date/Time Issued</th>
