...
<div className="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
  <div className="lg:w-4/5 sm:w-7/8 m-auto">
    <h1 className="text-2xl font-bold text-center">Nefarious: A Movie Review</h1>
    <p className="text-sm text-center text-dark dark:text-bg-gray p-5">
      Michael Fahnlander 9/3/23
    </p>
    <h1 className="text-lg font-bold text-center">My Review</h1>
    <div classNameName="video-responsive" className="w-1/2 m-auto">
      <iframe 
  ...
  <p className="text-sm text-center text-dark dark:text-bg-gray p-5">
      ...
      The movie does justice to the . Anyone who is not familiar with Theology (the study of God) can understand the points of view of the characters, and it is an excellent crashcourse without being preachy, cringe, or tacky.
  </p>
  <h1 className="text-lg font-bold text-center">Response to Criticism</h1>
  <p className="text-sm text-center text-dark dark:text-bg-gray p-5">
