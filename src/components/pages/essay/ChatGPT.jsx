...
<div class="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
  <div class="lg:w-4/5 sm:w-7/8 m-auto">
    ...
    <h1 class="text-lg font-bold text-center">II.	Overview of AI</h1>
    ...
    <h1 class="text-lg font-bold text-center">III.	Overview of ChatGPT</h1>
    ...
    <h1 class="text-lg font-bold text-center">IV.	Challenges of AI</h1>
    ...
    <h1 class="text-lg font-bold text-center">VI.	Cheating Detection Tools</h1>
    ...
    <h1 class="text-lg font-bold text-center">References</h1>
    ...
    <p class="text-base text-dark dark:text-bg-gray">
      [6] 	OpenAI, "AI Text Classifier," [Online]. Available: https://platform.openai.com/ai-text-classifier.
    </p>
    <p class="text-base text-dark dark:text-bg-gray">
