...
<div className="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
  <div className="lg:w-4/5 sm:w-7/8 m-auto">
    ...
    <div className="p-5 text-dark dark:text-bg-gray">
      The Autoruns tool bundled with Comodo Cleaning Essentials does a great job at listing in a friendly tree format the various processes that are supposed to automatically run from the registry. I will use this list of "Unknown" registry entries with Redline.
    </div>

    <img className='text-center' src={CCE} alt="" title="Comodo Cleaning Essentials"></img>
    <div className="p-5 text-dark dark:text-bg-gray">
      Comodo Cleaning Essentials found a single piece of malware in the form of a malicious registry entry. It categorizes the registry as a rootkit. We will check that entry against what Redline found.
    </div>
