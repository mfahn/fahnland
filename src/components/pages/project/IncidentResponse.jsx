...
<div class="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
  <div class="lg:w-4/5 sm:w-7/8 m-auto">
    <h1 class="text-lg font-bold text-center">Background</h1>
    <p class="p-5">
    ...
    <h1 class="text-lg font-bold text-center">Gameplan</h1>
    <p class="p-5">
      ...
      <div>
      <Link class="hover:text-lowTeal text-lowTeal dark:text-lowTeal dark:hover:text-teal" to="https://www.briancarr.org/post/adventures-with-inetsim">Inetsim Tutorial</Link>
      </div>
      <div>
        <Link class="hover:text-lowTeal text-lowTeal dark:text-lowTeal dark:hover:text-teal" to="https://www.briancarr.org/post/creating-a-virtual-network">VMWare Network Tutorial</Link>
      </div>
    </p>
    ...
    <img class="m-auto text-center" src={Switch} alt="" title="Switch Config"></img>
    <p class="p-5">
    ...
    <img class="text-center" src={Redline} alt="" title="Redline"></img>
    <div>
      <Link class="dark:text-lowTeal text-lowTeal text-center dark:hover:text-teal" to="https://fireeye.market/apps/211364">Redline Download</Link>
    </div>

    <h1 class="text-lg font-bold text-center">Network Findings</h1>
    ...
    <h1 class="text-lg font-bold text-center">Forensic Findings</h1>
    <p class="p-5">
      Processes 
      Running Processes
    ...
    <img class="text-center m-auto" src={Warning} alt="" title="Browser Warning"></img>
    <p class="p-5">
