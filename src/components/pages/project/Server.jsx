...
<div class="mt-5 m-auto p-5 w-4/5 text-dark bg-bg-gray rounded-lg dark:text-bg-gray dark:bg-navy">
  <div class="lg:w-4/5 sm:w-7/8 mr-auto ml-auto">
    ...
    <p class="ml-auto mr-auto">
      ...
      <p class="inline text-lowTeal"><a href='https://tteck.github.io/Proxmox'> Github</a></p>
    </p>
    <img class="lg:w-2/5 md:w-3/5 xl:2/5 sm:w-4/5 ml-auto mr-auto pt-5 pb-5" alt='' src={lab}></img>
    <p class="ml-auto mr-auto">
